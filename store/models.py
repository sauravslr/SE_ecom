...
class VariationManager(models.Manager):
    def options(self):
        return super(VariationManager, self).filter(variation_category='options', is_active=True)

    def bottle(self):
        return super(VariationManager, self).filter(variation_category='bottle', is_active=True)
